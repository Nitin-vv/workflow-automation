    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import( './pages/sms-templates/sms-templates.module' ).then( m => m.SmsTemplatesModule ),
            data: {
              toolbarShadowEnabled: true
            }
          }
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import( './pages/email-templates/email-templates.module' ).then( m => m.EmailTemplatesModule ),
            data: {
              toolbarShadowEnabled: true
            }
          }
