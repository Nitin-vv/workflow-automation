...
exports.deleteSmsTemplates = exports.updateStatus = exports.updateSmsTemplates = exports.createSmsTemplates = exports.getSmsTemplates = void 0;
const dotenv = __importStar(require("dotenv"));
const models_1 = __importDefault(require("../models"));
const messageEnums_1 = require("../enums/messageEnums");
const sequelize_1 = require("sequelize");
dotenv.config();
const SMS = models_1.default.SMS;
function calculateSkip(page, pageSize) {
    let skip;
    skip = ((page - 1) * pageSize);
    return skip;
}
const getSmsTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { count, rows } = yield SMS.findAndCountAll(options);
...
const createSmsTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { accountid, userid } = req.user;
    ...
    try {
        ...
        const isExists = yield SMS.findOne({
            where: {
                userid: userid,
                accountid: accountid,
                title: payload.title
        ...
        const isCreated = yield SMS.create(payload);
        if (isCreated) {
            res.send({
                status: true,
...
exports.createSmsTemplates = createSmsTemplates;
const updateSmsTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { accountid, userid } = req.user;
    ...
    try {
        ...
        if (!isExists) {
            ...
            const isUpdated = yield SMS.update({
                title,
                status,
                template,
                updatedAt: new Date(),
            ...
            const updatedUser = yield SMS.findOne({
                where: {
                    userid: userid,
                    accountid: accountid,
                    id: id
...
exports.updateSmsTemplates = updateSmsTemplates;
...
const deleteSmsTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let Ids = req.query.Ids;
    const { accountid, userid } = req.user;
    Ids = Ids.split(',').map(Number);
    try {
        const isDeleted = yield SMS.destroy({
            where: {
                id: {
...
exports.deleteSmsTemplates = deleteSmsTemplates;
